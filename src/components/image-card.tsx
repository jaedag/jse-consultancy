...
export default function ImageCard({ card }: { card: Card }) {
  return (
    <div className="rounded-3xl bg-gray-100 h-80 w-72 md:h-[40rem] md:w-96 overflow-hidden flex flex-col items-start justify-start relative z-10 cursor-pointer shadow-lg transform transition-transform duration-300 hover:scale-105 active:scale-95 ">
      ...
      {card.points && (
        <ul className="peer text-white text-sm md:text-base font-medium font-sans text-left z-10 mt-auto bg-black/50 p-4 w-full h-[50%]">
